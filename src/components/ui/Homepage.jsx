  ...
  const courses = [
    {
      ...
      desc2: 'Dive deep into object-oriented programming with Java, a versatile language used in everything from mobile apps to enterprise systems.'
    },
    {
      title: 'C Language',
      icon: Code,
      color: 'from-blue-400 to-green-500',
      description: 'Master the fundamentals of programming with C, the building block for all modern languages, and develop strong problem-solving skills.',
      desc2: 'Master the art of coding with our comprehensive curriculum.',
    },
    {
      title: 'Web Development',
      icon: Code,
      color: 'from-purple-400 to-pink-500',
      description: 'Learn how to build dynamic, user-friendly websites from scratch using the latest front-end and back-end development tools.',
      desc2: 'Master the art of coding with our comprehensive curriculum.',
    },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6 md:justify-start md:space-x-10">
            ...
            <nav className="hidden md:flex space-x-10">
              <Link to="/Login" className="text-base font-medium text-white hover:text-blue-400 transition-colors">
                ...
                <div className="pt-5 pb-6 px-5">
                  ...
                  <div className="mt-6">
                    <nav className="grid gap-y-8">
                      <Link to="/Login" className="ml-3 text-base font-medium text-white">
                        <span className="absolute left-[-15px] top-[6px] w-2 h-2 rounded-full bg-red-500 animate-blink"></span>
                        Live Class</Link>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {courses.map((course, index) => (
            ...
            >
              ...
              <p className="text-gray-300 mb-4">{course.desc2}</p>
              <Button
                variant="outline"
